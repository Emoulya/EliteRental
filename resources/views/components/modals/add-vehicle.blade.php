                ...
                <form id="addVehicleForm" method="POST" action="{{ route('admin.vehicles.store') }}"
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                            ...
                            <x-forms.checkbox-field name="additional_features[]" value="central_lock"
                                label="Central Lock" />
                            ...
                            <x-forms.checkbox-field name="additional_features[]" value="immobilizer"
                                label="Immobilizer" />
                            <x-forms.checkbox-field name="additional_features[]" value="child_safety_lock"
                                label="Child Safety Lock" />
                            <x-forms.checkbox-field name="additional_features[]" value="hazard_lights"
                                label="Lampu Hazard" />
                        </div>
